...
exports.chooseBotName = () => {
  return exports.choose([
    ...
    "M110",
    "No Kill Huhu:(",
    "R̶̯͉͕͈̼͖͎͘u̷̘͊̔͒̎͂͑̇̈́͐̂͒̕̕͝n̸̪̙̹͍̏̍ ̵̢͖̘̟̜͉͍͛̊ͅo̵̻̫̣͐͌̄̈́͆̆̓̕r̷̮̼̈̐͆̿͆͌́ ̸̧̨̧̯̳̬̟̞̩̖͎̈́̀̔̃̾̍͆͗͜͝ͅḐ̶̮̤̼̌̒́̑̎̕̚̕i̷̻̣̠̮͖̙̩̰̗͓͚̞̗̟͛̇͒̓̈́̄̋͑̂̋̐̈́̕͘͠ȇ̵̢̗̩͍̈̓̑́̔̅́̕͠͝!̷̨̧̪̠̤̫͙̭̪͙̘͍̰͊̚",
    "Me on my way to do YOUR MOM",
    "Unknown Entity",
    "Unknown-R̶̯͉͕͈̼͖͎͘ȇ̵̢̗̩͍̈̓̑́̔̅́̕͠͝-1",
    "Get F*cked",
    "Holy sh!t",
    "Aw HELL Naw",
    "Mastery of Garazz.io",
    "eeeeeeeeeeeeeeeeeeeeeeeeee",
    "aaa gogo gaga",
    "kill me = lgbtq+",
    "That Guyyyyyyyyyyyyyyyyyyy",
    "SOMEONE",
    "꧁༺𝓘𝓷𝓼𝓪𝓷𝓲𝓽𝔂༻꧂",
    "🅸 🅰🅼 🅶🅾🅳",
    "I",
    ...
    "Charlemagne",
    "Drako Hyena",
    "long nameeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
    ...
    "enemy.kill()",
    "what the hell",
    "I AM SPEEEEEEEEEEEEEEEEEEEEEEEEEEED",
    "GET TO DA CHOPPA!!!",
    "f*ck your mama",
    "꧁꧂꧁꧂꧁꧂꧁꧂꧁꧂꧁꧂",
    ...
    "I'm LGBTQ+",
    "Don't eat me plz",
    "Chicken you so beautiful",
    "GARAZZZZZZZZZZZZZZZZZZZZZZZZZZ",
    "zZz",
    "sleepwalker",
    "wadahellllllll",
    "what the hell oh my god no way",
    "skibidi toilet ohio sigma rizz",
    //randon chinese things
    "杰巍杰凼㢂女",
    "洗嗎起嘉嘉祝熱吸囡童鍊油縫籬燶科源終趕爆錶支烸四媽海燶當海填級輝京派土",
    "積樓昨學長場錯動梓好習童奶童錯楞級煩填土",
    "水火火京壞爆食志凍源童火水女山人水火米崔源崔熱癈哂火",
    "場跟粉黑爆埕十",
    "源粉胃地媽維穿樓馬維系屎很城米雞竹",
    "場寫眼校學煲熱因籬愛糕囡學嫌耀妙寫銖聖穿嫌米尸",
    "嗎畈去衣崴熱凍吸油店炭維當吸崔給潤里炭熊圈浴座熱油吆童土",
    "糖埕護岫烸媽畢潤級鍊逼室縫護當輝燶京潤畈燶評墙女",
    "崔法墙源童幽鐺源祝赴當浴赴祝畈煩油祝耀填鍊畈維評囡京寫潤資媽赴油衣凍爆熱評填爆細",
    "复古风也见过我无法不分贵贱一个个v经营范围v范围v因为测赶紧发个吃完饭更有感觉",
    "复古陶瓷他v也服务员vu个吃惹",
    "发染发无辜一件衣服我发个画册u也i次被粉碎宝贵财产受到鬼北方擦u一般的冲动",
    "热啊发布会几个啊根本让肌肤喝啊就会个分别根据本法如果几百万发热据国家为v如果有v家",
    "人仿佛不顾对方是否被眷顾的v双肩包复古是v都不分贵贱已经度过一个v方式",
    "爆耀起資地京去去六城米去童米賢雞函源聖崩寫勝鐵烸梓趕衣源勝耀這派",
    "晦埕單潤支旺糕音爆熱童終報增爆赴媽響終潤媽最晨耀京媽級評旺泊終壞寫閱吸維音浴嶵女",
    "爆收自愛幾匕當涌祝維畈煲統凍糖幾炭嘴源威愛瑩很起黑法眼爆座師爆里很熊級火",
    "牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛牛",
    "鸡你太美鸡你太美鸡你太美鸡你太美鸡你太美鸡你太美鸡你太美鸡你太美",
    "休息中zzz",
    "蹿房越脊付出才有饭局要参加一次发酒疯一次过财富广场v抚养费剧场非常有附近一次异彩纷呈",
    "443/、后悔举报发的红包v佛啊",
    "保护非常不差u发微博的除恶是壁挂式",
    "牛非常你好份额为佛份烦恼超级大超级超级禁毒日宿舍门上，三",
    "灿父㐪臁笵灿父㐪昛筗对父-己鈦丑灿父湒",
    "𣄽多閬壠錬潱栾注戝東洼粲鈿釥𢿣娋辿㽊妥母峭潧鬼𢚖尨沙鎴祱𣶶略少鏿鉬夈䵯㕙𨥨鈿沵山竹",
    "操操操操操",
    "我想操你",
    "我操你妈逼",
    "画册u办法不和次发微博和u我非常不顾违法成本观测非常符合本规范和次被恶意d好",
    "哇他发一素哈品宁看爱发哭哟",
    "第四季诶我科科姐姐我外婆视频送快递雕刻精美的",
    "你看起来很好吃哟：）",
    "想保着命子就给我滚！",
  ]);
};
